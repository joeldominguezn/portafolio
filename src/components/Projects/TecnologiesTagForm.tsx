...
export default function TecnologiesTagForm({ availableOptions, placeholder = "Selecciona...", onTecSelected }: Props) {
    ...
    return (
        <div className="relative w-full py-5" data-aos="fade-up">
            <div
            ...
            >
                ...
                <input
                    ref={inputRef}
                    type="text"
                    className="flex grow bg-transparent border-none outline-none p-0 text-gray-900 dark:text-gray-300 min-w-25 placeholder-gray-500 focus:ring-transparent ml-1"
