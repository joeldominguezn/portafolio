    ...
    return (
        <div className="flex flex-col gap-y-5">
            <div id="filters" className="flex flex-col w-full">
                <div data-aos="fade-up" className="flex items-center gap-x-2">
                    <FilterIcon className="size-6 fill-text" />
                    <h1 className="text-xl font-bold">Filtros</h1>
                </div>
                <h3 className="text-lg" data-aos="fade-up">Buscar</h3>
                <SearchBar onSearch={onSearch} />
                <h3 className="text-lg" data-aos="fade-up">Tecnologías</h3>
                <TecnologiesTagForm availableOptions={Categories} onTecSelected={onTecSelected} />
                <h3 className="text-lg" data-aos="fade-up">Ordenar</h3>
